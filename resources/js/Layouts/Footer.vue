...
<template>
    <footer class="text-center text-white" style="background-color: #661313;">

        <div class="text-center p-4 pt-5" style="background-color: #661313;">
             <div class="flex justify-center mb-9">
                <a href="#!" class="mr-9 text-gray-800" style="color: yellow;">
                    <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
            ...
            ©2022 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">Saint Rose of Lima Parish</a>
        </div>
    </footer>
</template>
